...
export class ErrorHandler {
  ...
  createError(
    ...
    (error as Error & { type: ErrorType; severity: ErrorSeverity }).type = type;
    (error as Error & { type: ErrorType; severity: ErrorSeverity }).severity = severity;
    return error;
  }
   ...
   * 获取用户友好的错误消息
   */
  private getUserMessage(type: ErrorType, _error: Error | string): string {
