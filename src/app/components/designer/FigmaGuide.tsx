/**
 * file: FigmaGuide.tsx
 * description: Figma 指南组件 — Figma 设计规范和最佳实践指南组件
 * author: YanYuCloudCube Team <admin@0379.email>
 * version: v1.0.0
 * created: 2026-03-08
 * updated: 2026-04-04
 * status: stable
 * tags: component,designer,figma,guide
 */

import React, { useState, useMemo } from 'react';
import {
  X, Figma, ArrowRight, Copy, Check, Sparkles, Palette,
  MousePointerClick, Layers, Table, FormInput,
  SquareKanban, ChevronRight, Zap, Database,
