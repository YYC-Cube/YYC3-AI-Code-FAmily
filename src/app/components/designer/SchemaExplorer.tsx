 ...
 * description: Schema 浏览器组件 — 数据库结构浏览和探索组件
 * author: YanYuCloudCube Team <admin@0379.email>
 * version: v1.0.0
 * created: 2026-03-08
 * updated: 2026-04-04
 * status: stable
 * tags: component,designer,schema,database
 */

import React, { useState } from 'react';
import {
  X, Database, Table, ChevronRight, ChevronDown, Link2,
  Key, Hash, Type, Calendar, ToggleLeft, Search,
  Code, Copy, Check, FileCode2
} from 'lucide-react';
...
export function SchemaExplorer() {
  const { schemaExplorerOpen, toggleSchemaExplorer, setDataBinding, selectedComponentId, dataBindings } = useDesigner();
