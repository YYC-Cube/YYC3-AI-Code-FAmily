/**
 * file: StatusBar.tsx
 * description: 状态栏组件 — 底部状态栏，显示系统状态、CRDT 连接、AI Token 等信息
 * author: YanYuCloudCube Team <admin@0379.email>
 * version: v1.0.0
 * created: 2026-03-08
 * updated: 2026-04-04
 * status: stable
 * tags: component,designer,status-bar,ui
 */

import { useState, useEffect, useRef, useMemo } from 'react';
import { Wifi, WifiOff, Cpu, Sparkles, Clock, Users, Zap, Database, Magnet, Layers, Activity, ShieldCheck, ShieldAlert, Eye, Lock, ChevronUp, ChevronDown, CheckCircle2, XCircle, AlertTriangle, FileJson, Copy } from 'lucide-react';
import { useDesigner } from '../../store';
import { Tooltip } from './Tooltip';
import { useThemeTokens } from './hooks/useThemeTokens';
import { api } from '../../apiClient';
import { useGlobalAI } from '../../aiModelContext';
import { useHealthMonitor } from '../ErrorBoundary';
...
export function StatusBar() {
  ...
  const { status: modelStatus, latency: modelLatency } = useModelHealth(30_000);
