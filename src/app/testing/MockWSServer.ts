 ...
 * description: 模拟 y-websocket 服务器 — 用于浏览器端 E2E 多人协同测试，完整实现 SYNC_STEP1/STEP2/UPDATE/AWARENESS/PING/PONG 协议，支持多房间、模拟延迟、丢包、断线、冲突注入，以及自动化测试断言
...
export class MockWSServer {
  ...
  injectConflict(roomName: string, text: string) {
    ...
    room.clients.forEach((_client, id) => {
