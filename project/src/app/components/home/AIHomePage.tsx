...
import {
  Bot, Sparkles, Send, Plus, Image as ImageIcon, FileUp, Github, Figma,
  Code2, Clipboard, ArrowRight, Clock, MoreHorizontal, Layers, Palette,
  Rocket, Zap, Settings, FolderOpen, BrainCircuit, LayoutDashboard,
  Monitor, Cpu, Globe, ChevronRight, Star, TrendingUp, Users, Activity,
  Trash2, Pencil, Copy, GripVertical, X, FileCode2, Database,
  PenTool, ChartBar, Table, FormInput, Workflow, Eye,
...
const INITIAL_PROJECTS: ProjectItem[] = [
  { id: 'proj-1', name: 'YANYUCLOUD Designer', desc: '多联式低码设计器', icon: LayoutDashboard, color: '#6366f1', updated: '2 分钟前', status: 'active', stats: { panels: 4, components: 9, files: 23 }, route: 'designer' },
