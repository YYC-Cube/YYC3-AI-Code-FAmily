...
const MOCK_TIMELINE: TimelineEntry[] = [
  { id: 'tl-1', peerId: 'self', peerName: '你', color: '#6366f1', type: 'update', target: 'comp-1.props.label → "提交订单"', timestamp: Date.now() - 2000, snapshotId: 'snap-001' },
  ...
  { id: 'tl-5', peerId: 'self', peerName: '你', color: '#6366f1', type: 'insert', target: 'panel-3 → comp-9 (Button)', timestamp: Date.now() - 25000, snapshotId: 'snap-005' },
  ...
  { id: 'tl-8', peerId: 'self', peerName: '你', color: '#6366f1', type: 'update', target: 'comp-3.props.columns → ["名称","状态","操作"]', timestamp: Date.now() - 60000, snapshotId: 'snap-008' },
