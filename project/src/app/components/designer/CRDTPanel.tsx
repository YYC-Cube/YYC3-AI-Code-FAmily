...
import {
  X, Wifi, WifiOff, Users, GitBranch, RefreshCw, CheckCircle2,
  AlertTriangle, Radio, Eye, Database, Clock, Zap,
  ChevronRight, Copy, Check, ArrowUpDown, Circle,
  ArrowDown, ArrowUp, HardDrive, Shield, ShieldCheck,
  Lock, Unlock, UserCog, Timer, History, Crown
} from 'lucide-react';
import { useDesigner } from '../../store';
import { copyToClipboard } from '../../utils/clipboard';
import { useYjsBinding, type WSMessage } from './useYjsBinding';
...
const MOCK_CHANGES: CRDTChange[] = [
  ...
  { id: 'ch-2', peerId: 'self', peerName: '你', color: '#6366f1', type: 'insert', target: 'panel-4 → comp-9 (Button)', timestamp: Date.now() - 8000 },
  ...
  { id: 'ch-6', peerId: 'self', peerName: '你', color: '#6366f1', type: 'delete', target: 'comp-old-3 (removed)', timestamp: Date.now() - 40000 },
